...
;
	($.$bog_tracker_profile_page) = class $bog_tracker_profile_page extends ($.$mol_page) {
		back_click(next){
			if(next !== undefined) return next;
			return null;
		}
		Back(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_profile_page_Back_title")));
		...
		Name_input(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_profile_page_Name_input_hint")));
			(obj.value) = (next) => ((this.name(next)));
			return obj;
		}
		Name_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_profile_page_Name_field_title")));
		...
		Role_input(){
			...
			(obj.options) = () => ((this.role_options()));
			return obj;
		}
		Role_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_profile_page_Role_field_title")));
			(obj.content) = () => ([(this.Role_input())]);
			return obj;
		}
		Form(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Name_field()), (this.Role_field())]);
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$bog_tracker_profile_page_title"));
		}
		store(){
			const obj = new this.$.$bog_tracker_store();
			return obj;
		}
		role_options(){
			return {
				"student": (this.$.$mol_locale.text("$bog_tracker_profile_page_role_options_student")), 
				"teacher": (this.$.$mol_locale.text("$bog_tracker_profile_page_role_options_teacher")), 
				"parent": (this.$.$mol_locale.text("$bog_tracker_profile_page_role_options_parent"))
			};
		}
		tools(){
			return [(this.Back())];
	...
	($mol_mem(($.$bog_tracker_profile_page.prototype), "back_click"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Back"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "name"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Name_input"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Name_field"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "role"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Role_input"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Role_field"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "Form"));
	($mol_mem(($.$bog_tracker_profile_page.prototype), "store"));
    ...
    (function ($$) {
        class $bog_tracker_profile_page extends $.$bog_tracker_profile_page {
            ...
            role(next) {
                ...
                return (this.profile_existing()?.role()?.val() ?? 'student');
            }
            back_click(next) {
                if (next === undefined)
                    return null;
        ...
        __decorate([
            $mol_action
        ], $bog_tracker_profile_page.prototype, "profile_ensure", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_profile_page.prototype, "name", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_profile_page.prototype, "role", null);
        __decorate([
            $mol_action
        ], $bog_tracker_profile_page.prototype, "back_click", null);
        $$.$bog_tracker_profile_page = $bog_tracker_profile_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($bog_tracker_profile_page, {
            Form: {
                gap: $mol_gap.block,
                padding: $mol_gap.block,
            },
...
var $;
(function ($) {
    class $bog_tracker_comment extends $giper_baza_entity.with({
        text: $giper_baza_atom_text,
        author_name: $giper_baza_atom_text,
        created_iso: $giper_baza_atom_text,
    }) {
    }
    $.$bog_tracker_comment = $bog_tracker_comment;
    class $bog_tracker_profile extends $giper_baza_entity.with({
        name: $giper_baza_atom_text,
        role: $giper_baza_atom_text,
    }) {
    }
    $.$bog_tracker_profile = $bog_tracker_profile;
    class $bog_tracker_task extends $giper_baza_entity.with({
    ...
    $.$bog_tracker_task = $bog_tracker_task;
    class $bog_tracker_registry extends $giper_baza_entity.with({
    ...
    $.$bog_tracker_registry = $bog_tracker_registry;
    class $bog_tracker_store extends $mol_object {
        glob() {
        ...
        registry() {
            return this.home_land().Data($bog_tracker_registry);
        }
    }
    $.$bog_tracker_store = $bog_tracker_store;
})($ || ($ = {}));
...
;
	($.$bog_tracker_row) = class $bog_tracker_row extends ($.$mol_view) {
		task_done(next){
			if(next !== undefined) return next;
			return false;
		}
		...
		Check(){
			const obj = new this.$.$mol_check_icon();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_row_Check_hint")));
			(obj.checked) = (next) => ((this.task_done(next)));
			(obj.Icon) = () => ((this.Check_icon()));
			return obj;
		}
		task_click(next){
			if(next !== undefined) return next;
		...
		Subject(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.task_subject())]);
			return obj;
		}
		Deadline(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.task_deadline())]);
			return obj;
		}
		Assignee(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.task_assignee())]);
			return obj;
		}
		Meta(){
			const obj = new this.$.$mol_view();
		...
		Main(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.task_click(next)));
			(obj.sub) = () => ([(this.Title_row()), (this.Meta())]);
			return obj;
		}
		Priority(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.task_priority())]);
			return obj;
		}
		task_id(){
			return "";
		...
		attr(){
			return {
				...(super.attr()), 
				"bog_tracker_row_overdue": (this.task_overdue()), 
				"bog_tracker_row_priority": (this.task_priority())
			};
		}
		sub(){
			return [
	...
	($mol_mem(($.$bog_tracker_row.prototype), "task_done"));
	($mol_mem(($.$bog_tracker_row.prototype), "Check_icon"));
	($mol_mem(($.$bog_tracker_row.prototype), "Check"));
	($mol_mem(($.$bog_tracker_row.prototype), "task_click"));
	($mol_mem(($.$bog_tracker_row.prototype), "Title_row"));
	($mol_mem(($.$bog_tracker_row.prototype), "Subject"));
	($mol_mem(($.$bog_tracker_row.prototype), "Deadline"));
	($mol_mem(($.$bog_tracker_row.prototype), "Assignee"));
	($mol_mem(($.$bog_tracker_row.prototype), "Meta"));
	($mol_mem(($.$bog_tracker_row.prototype), "Main"));
	($mol_mem(($.$bog_tracker_row.prototype), "Priority"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$bog_tracker_row = $bog_tracker_row;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tracker_list) = class $bog_tracker_list extends ($.$mol_page) {
		filter(next){
			if(next !== undefined) return next;
			return "all";
		}
		...
		title(){
			return (this.$.$mol_locale.text("$bog_tracker_list_title"));
		}
		store(){
			const obj = new this.$.$bog_tracker_store();
			return obj;
		...
		filter_options(){
			return {
				"all": (this.$.$mol_locale.text("$bog_tracker_list_filter_options_all")), 
				"active": (this.$.$mol_locale.text("$bog_tracker_list_filter_options_active")), 
				"done": (this.$.$mol_locale.text("$bog_tracker_list_filter_options_done")), 
				"overdue": (this.$.$mol_locale.text("$bog_tracker_list_filter_options_overdue"))
			};
		}
		empty_text(){
			return (this.$.$mol_locale.text("$bog_tracker_list_empty_text"));
		}
		new_task_title(){
			return (this.$.$mol_locale.text("$bog_tracker_list_new_task_title"));
		}
		Filter_switch(){
			const obj = new this.$.$mol_switch();
		...
		New_task(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.new_task_title()));
			(obj.click) = (next) => ((this.new_task_click(next)));
			return obj;
		}
		Head_bar(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Filter_switch()), (this.New_task())]);
			return obj;
		}
		Row(id){
			const obj = new this.$.$bog_tracker_row();
			(obj.task_id) = () => ((this.task_id(id)));
			(obj.task_title) = () => ((this.task_title(id)));
			(obj.task_subject) = () => ((this.task_subject(id)));
			(obj.task_deadline) = () => ((this.task_deadline(id)));
			(obj.task_priority) = () => ((this.task_priority(id)));
			(obj.task_done) = (next) => ((this.task_done(id, next)));
			(obj.task_overdue) = () => ((this.task_overdue(id)));
			(obj.task_assignee) = () => ((this.task_assignee(id)));
			(obj.task_click) = (next) => ((this.task_click(id, next)));
			return obj;
		}
		Rows_list(){
			const obj = new this.$.$mol_list();
		...
		head(){
			return [(this.Title()), (this.Head_bar())];
		}
		body(){
			return (this.content());
		}
	};
	($mol_mem(($.$bog_tracker_list.prototype), "filter"));
	($mol_mem(($.$bog_tracker_list.prototype), "new_task_click"));
	($mol_mem_key(($.$bog_tracker_list.prototype), "task_done"));
	($mol_mem_key(($.$bog_tracker_list.prototype), "task_click"));
	($mol_mem(($.$bog_tracker_list.prototype), "Empty_text"));
	($mol_mem(($.$bog_tracker_list.prototype), "store"));
	($mol_mem(($.$bog_tracker_list.prototype), "Filter_switch"));
	($mol_mem(($.$bog_tracker_list.prototype), "New_task"));
	($mol_mem(($.$bog_tracker_list.prototype), "Head_bar"));
	($mol_mem_key(($.$bog_tracker_list.prototype), "Row"));
	($mol_mem(($.$bog_tracker_list.prototype), "Rows_list"));
	($mol_mem(($.$bog_tracker_list.prototype), "Empty"));
...
(function ($) {
    var $$;
    (function ($$) {
        function is_overdue(deadline, done) {
            if (done)
                return false;
            if (!deadline)
                return false;
        ...
        class $bog_tracker_list extends $.$bog_tracker_list {
            ...
            filtered_tasks() {
                ...
                switch (filter) {
                    ...
                    case 'overdue':
                        return tasks.filter(t => is_overdue(t.deadline()?.val() ?? '', t.done()?.val() ?? false));
                    default:
                        return tasks;
                }
            }
            ...
            task_priority(id) {
                return (this.task_by_id(id)?.priority()?.val() ?? 'medium');
            }
            task_done(id, next) {
            ...
            task_overdue(id) {
                ...
                if (!task)
                    return false;
                return is_overdue(task.deadline()?.val() ?? '', task.done()?.val() ?? false);
            }
            task_assignee(id) {
        ...
        __decorate([
            $mol_mem
        ], $bog_tracker_list.prototype, "filter", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_list.prototype, "registry_ready", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_list.prototype, "all_tasks", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_list.prototype, "filtered_tasks", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_list.prototype, "row_ids", null);
        __decorate([
            $mol_mem_key
        ], $bog_tracker_list.prototype, "task_by_id", null);
        $$.$bog_tracker_list = $bog_tracker_list;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tracker_task_form) = class $bog_tracker_task_form extends ($.$mol_page) {
		back_click(next){
			if(next !== undefined) return next;
			return null;
		}
		Back(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Back_title")));
			(obj.click) = (next) => ((this.back_click(next)));
			return obj;
		}
		draft_subject(next){
		...
		Subject_input(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Subject_input_hint")));
			(obj.value) = (next) => ((this.draft_subject(next)));
			return obj;
		}
		Subject_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Subject_field_title")));
		...
		Title_input(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Title_input_hint")));
			(obj.value) = (next) => ((this.draft_title(next)));
			return obj;
		}
		Title_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Title_field_title")));
		...
		Deadline_input(){
			const obj = new this.$.$mol_date();
			(obj.value) = (next) => ((this.draft_deadline(next)));
			return obj;
		}
		Deadline_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Deadline_field_title")));
			(obj.content) = () => ([(this.Deadline_input())]);
			return obj;
		}
		draft_priority(next){
			if(next !== undefined) return next;
		...
		Priority_input(){
			const obj = new this.$.$mol_switch();
			(obj.value) = (next) => ((this.draft_priority(next)));
			(obj.options) = () => ((this.priority_options()));
			return obj;
		}
		Priority_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Priority_field_title")));
			(obj.content) = () => ([(this.Priority_input())]);
			return obj;
		}
		draft_assignee(next){
			if(next !== undefined) return next;
		...
		Assignee_input(){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Assignee_input_hint")));
			(obj.value) = (next) => ((this.draft_assignee(next)));
			return obj;
		}
		Assignee_field(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Assignee_field_title")));
			(obj.content) = () => ([(this.Assignee_input())]);
			return obj;
		}
		save_click(next){
			if(next !== undefined) return next;
		...
		Save(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_form_Save_title")));
			(obj.click) = (next) => ((this.save_click(next)));
			return obj;
		}
		Form(){
			const obj = new this.$.$mol_list();
		...
		title(){
			return (this.$.$mol_locale.text("$bog_tracker_task_form_title"));
		}
		store(){
			const obj = new this.$.$bog_tracker_store();
			return obj;
		...
		priority_options(){
			return {
				"low": (this.$.$mol_locale.text("$bog_tracker_task_form_priority_options_low")), 
				"medium": (this.$.$mol_locale.text("$bog_tracker_task_form_priority_options_medium")), 
				"high": (this.$.$mol_locale.text("$bog_tracker_task_form_priority_options_high"))
			};
		}
		tools(){
			return [(this.Back())];
	...
	($mol_mem(($.$bog_tracker_task_form.prototype), "back_click"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Back"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "draft_subject"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Subject_input"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Subject_field"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "draft_title"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Title_input"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Title_field"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "draft_deadline"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Deadline_input"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Deadline_field"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "draft_priority"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Priority_input"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Priority_field"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "draft_assignee"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Assignee_input"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Assignee_field"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "save_click"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Save"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "Form"));
	($mol_mem(($.$bog_tracker_task_form.prototype), "store"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_action
        ], $bog_tracker_task_form.prototype, "back_click", null);
        __decorate([
            $mol_action
        ], $bog_tracker_task_form.prototype, "save_click", null);
        $$.$bog_tracker_task_form = $bog_tracker_task_form;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($bog_tracker_task_form, {
            Form: {
                gap: $mol_gap.block,
                padding: $mol_gap.block,
            },
...
;
	($.$bog_tracker_task_page) = class $bog_tracker_task_page extends ($.$mol_page) {
		back_click(next){
			if(next !== undefined) return next;
			return null;
		}
		...
		comment_author_text(id){
			return "";
		}
		Comment_author(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comment_author_text(id)));
			return obj;
		}
		comment_body_text(id){
			return "";
		}
		Comment_body(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comment_body_text(id)));
			return obj;
		}
		comment_date_text(id){
			return "";
		}
		Comment_date(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comment_date_text(id)));
			return obj;
		}
		comment_rows(){
			return [];
		...
		no_task_text(){
			return (this.$.$mol_locale.text("$bog_tracker_task_page_no_task_text"));
		}
		subject_label(){
			return "";
		}
		...
		done_label(){
			return (this.$.$mol_locale.text("$bog_tracker_task_page_done_label"));
		}
		comment_empty_text(){
			return (this.$.$mol_locale.text("$bog_tracker_task_page_comment_empty_text"));
		}
		back_title(){
			return (this.$.$mol_locale.text("$bog_tracker_task_page_back_title"));
		}
		Back(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.back_title()));
			(obj.click) = (next) => ((this.back_click(next)));
			return obj;
		}
		Done_toggle(){
			...
			(obj.title) = () => ((this.done_label()));
			return obj;
		}
		tools(){
			return [(this.Back()), (this.Done_toggle())];
		}
		Subject_row(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.subject_label()));
			return obj;
		}
		Deadline_row(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.deadline_label()));
			return obj;
		}
		Priority_row(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.priority_label()));
			return obj;
		}
		Assignee_row(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.assignee_label()));
			return obj;
		}
		Author_row(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.author_label()));
			return obj;
		}
		Meta_block(){
			const obj = new this.$.$mol_view();
		...
		Comment_row(id){
			...
			(obj.sub) = () => ([
				...
				(this.Comment_body(id)), 
				(this.Comment_date(id))
			]);
			return obj;
		}
		Comments_title(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_page_Comments_title_title")));
			return obj;
		}
		Comments_list(){
			const obj = new this.$.$mol_list();
		...
		Comment_empty(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comment_empty_text()));
			return obj;
		}
		Comment_input(){
			const obj = new this.$.$mol_textarea();
			(obj.hint) = () => ((this.$.$mol_locale.text("$bog_tracker_task_page_Comment_input_hint")));
			(obj.value) = (next) => ((this.comment_text(next)));
			return obj;
		}
		Comment_submit(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_tracker_task_page_Comment_submit_title")));
			(obj.click) = (next) => ((this.comment_submit(next)));
			return obj;
		}
		Comment_form(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Comment_input()), (this.Comment_submit())]);
			return obj;
		}
		Comments_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.comments_block_content()));
			return obj;
		}
		Missing(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$bog_tracker_task_page.prototype), "back_click"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "done"));
	($mol_mem_key(($.$bog_tracker_task_page.prototype), "Comment_author"));
	($mol_mem_key(($.$bog_tracker_task_page.prototype), "Comment_body"));
	($mol_mem_key(($.$bog_tracker_task_page.prototype), "Comment_date"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "comment_text"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "comment_submit"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Missing_text"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "store"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Back"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Done_toggle"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Subject_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Deadline_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Priority_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Assignee_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Author_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Meta_block"));
	($mol_mem_key(($.$bog_tracker_task_page.prototype), "Comment_row"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comments_title"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comments_list"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comment_empty"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comment_input"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comment_submit"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comment_form"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Comments_block"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Missing"));
	($mol_mem(($.$bog_tracker_task_page.prototype), "Body_content"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_tracker_task_page extends $.$bog_tracker_task_page {
            ...
            priority() {
                return (this.task()?.priority()?.val() ?? 'medium');
            }
            assignee() {
        ...
        __decorate([
            $mol_mem
        ], $bog_tracker_task_page.prototype, "task_id", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_task_page.prototype, "task", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_task_page.prototype, "comments", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_task_page.prototype, "comment_ids", null);
        __decorate([
            $mol_mem_key
        ], $bog_tracker_task_page.prototype, "comment_by_id", null);
        __decorate([
            $mol_action
        ], $bog_tracker_task_page.prototype, "back_click", null);
        __decorate([
            $mol_action
        ], $bog_tracker_task_page.prototype, "comment_submit", null);
        $$.$bog_tracker_task_page = $bog_tracker_task_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tracker_progress) = class $bog_tracker_progress extends ($.$mol_view) {
		Fill(){
			const obj = new this.$.$mol_view();
			(obj.style) = () => ({"width": (this.percent_width())});
			return obj;
		}
		Track(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$bog_tracker_progress.prototype), "Fill"));
	($mol_mem(($.$bog_tracker_progress.prototype), "Track"));
	($mol_mem(($.$bog_tracker_progress.prototype), "Label"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$bog_tracker_progress = $bog_tracker_progress;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_tracker_app) = class $bog_tracker_app extends ($.$mol_page) {
		Home(){
			const obj = new this.$.$bog_tracker_list();
			(obj.store) = () => ((this.store()));
			return obj;
		}
		New(){
			const obj = new this.$.$bog_tracker_task_form();
			(obj.store) = () => ((this.store()));
			return obj;
		}
		Task(){
			const obj = new this.$.$bog_tracker_task_page();
			(obj.store) = () => ((this.store()));
			return obj;
		}
		Profile(){
			const obj = new this.$.$bog_tracker_profile_page();
			(obj.store) = () => ((this.store()));
			return obj;
		}
		screen(next){
		...
		Sources(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/b-on-g/tracker");
			return obj;
		}
		Status(){
			const obj = new this.$.$giper_baza_status();
		...
		title(){
			return (this.$.$mol_locale.text("$bog_tracker_app_title"));
		}
		store(){
			const obj = new this.$.$bog_tracker_store();
			return obj;
		...
		nav_options(){
			return {"home": (this.$.$mol_locale.text("$bog_tracker_app_nav_options_home")), "profile": (this.$.$mol_locale.text("$bog_tracker_app_nav_options_profile"))};
		}
		Navbar(){
			const obj = new this.$.$mol_switch();
		...
		Progress(){
			const obj = new this.$.$bog_tracker_progress();
			(obj.done_count) = () => ((this.done_count()));
	...
	($mol_mem(($.$bog_tracker_app.prototype), "Home"));
	($mol_mem(($.$bog_tracker_app.prototype), "New"));
	($mol_mem(($.$bog_tracker_app.prototype), "Task"));
	($mol_mem(($.$bog_tracker_app.prototype), "Profile"));
	($mol_mem(($.$bog_tracker_app.prototype), "screen"));
	($mol_mem(($.$bog_tracker_app.prototype), "Sources"));
	($mol_mem(($.$bog_tracker_app.prototype), "Status"));
	($mol_mem(($.$bog_tracker_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_tracker_app.prototype), "Theme"));
	($mol_mem(($.$bog_tracker_app.prototype), "store"));
	($mol_mem(($.$bog_tracker_app.prototype), "Navbar"));
	($mol_mem(($.$bog_tracker_app.prototype), "Progress"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_tracker_app.prototype, "screen", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_app.prototype, "screen_body", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_app.prototype, "all_tasks", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_app.prototype, "total_count", null);
        __decorate([
            $mol_mem
        ], $bog_tracker_app.prototype, "done_count", null);
        $$.$bog_tracker_app = $bog_tracker_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
