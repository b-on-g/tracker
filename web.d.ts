...
declare namespace $ {
	...
	type $mol_button_minor__title_bog_tracker_profile_page_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_tracker_profile_page_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_profile_page['back_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_string__hint_bog_tracker_profile_page_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_bog_tracker_profile_page_4 = $mol_type_enforce<
		ReturnType< $bog_tracker_profile_page['name'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_labeler__title_bog_tracker_profile_page_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_profile_page_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_switch__value_bog_tracker_profile_page_7 = $mol_type_enforce<
		ReturnType< $bog_tracker_profile_page['role'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_tracker_profile_page_8 = $mol_type_enforce<
		ReturnType< $bog_tracker_profile_page['role_options'] >
		,
		ReturnType< $mol_switch['options'] >
	>
	type $mol_labeler__title_bog_tracker_profile_page_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_profile_page_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_list__rows_bog_tracker_profile_page_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	export class $bog_tracker_profile_page extends $mol_page {
		...
		Role_input( ): $mol_switch
		Role_field( ): $mol_labeler
		Form( ): $mol_list
		title( ): string
		store( ): $bog_tracker_store
		role_options( ): ({ 
			'student': string,
			'teacher': string,
			'parent': string,
...
declare namespace $.$$ {
    class $bog_tracker_profile_page extends $.$bog_tracker_profile_page {
        profile_existing(): $bog_tracker_profile | null;
        profile_ensure(): $bog_tracker_profile | null;
        name(next?: string): string;
        role(next?: any): any;
        back_click(next?: any): any;
    }
...
declare namespace $ {
    const $bog_tracker_comment_base: Omit<typeof $giper_baza_entity, "prototype"> & {
    ...
    export class $bog_tracker_comment extends $bog_tracker_comment_base {
    }
    const $bog_tracker_profile_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly name: (auto?: any) => $giper_baza_atom_text | null;
    ...
    export class $bog_tracker_profile extends $bog_tracker_profile_base {
    }
    const $bog_tracker_task_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly subject: (auto?: any) => $giper_baza_atom_text | null;
            readonly title: (auto?: any) => $giper_baza_atom_text | null;
            readonly deadline: (auto?: any) => $giper_baza_atom_text | null;
            readonly priority: (auto?: any) => $giper_baza_atom_text | null;
            readonly done: (auto?: any) => $giper_baza_atom_bool | null;
            readonly author_name: (auto?: any) => $giper_baza_atom_text | null;
            readonly assignee_name: (auto?: any) => $giper_baza_atom_text | null;
            readonly Comments: (auto?: any) => {
                remote_list(next?: readonly $bog_tracker_comment[] | undefined): readonly $bog_tracker_comment[];
                remote_add(item: $bog_tracker_comment): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_comment;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
        ...
        schema: {
            ...
            readonly title: typeof $giper_baza_atom_text;
            readonly deadline: typeof $giper_baza_atom_text;
            readonly priority: typeof $giper_baza_atom_text;
            readonly done: typeof $giper_baza_atom_bool;
            readonly author_name: typeof $giper_baza_atom_text;
            readonly assignee_name: typeof $giper_baza_atom_text;
            readonly Comments: {
                new (): {
                    remote_list(next?: readonly $bog_tracker_comment[] | undefined): readonly $bog_tracker_comment[];
                    remote_add(item: $bog_tracker_comment): void;
    ...
    export class $bog_tracker_task extends $bog_tracker_task_base {
    }
    const $bog_tracker_registry_base: Omit<typeof $giper_baza_entity, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_entity, {
            readonly Items: (auto?: any) => $giper_baza_list_link | null;
            readonly Tasks: (auto?: any) => {
                remote_list(next?: readonly $bog_tracker_task[] | undefined): readonly $bog_tracker_task[];
                remote_add(item: $bog_tracker_task): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_task;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Profile: (auto?: any) => {
                Value: Value;
                remote(next?: $bog_tracker_profile | null | undefined): $bog_tracker_profile | null;
                remote_of(peer: $giper_baza_link | null, next?: $bog_tracker_profile | null | undefined): $bog_tracker_profile | null;
                ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_profile | null;
                ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_profile | null;
                ensure_here(peer: $giper_baza_link | null): void;
                ensure_area(peer: $giper_baza_link | null, land: $giper_baza_land): void;
                ensure_lord(peer: $giper_baza_link | null, preset: $giper_baza_rank_preset): void;
                remote_ensure(preset?: $giper_baza_rank_preset): $bog_tracker_profile | null;
                local_ensure(): $bog_tracker_profile | null;
                val(next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                val_of(peer: $giper_baza_link | null, next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                pick_unit(peer: $giper_baza_link | null): $giper_baza_unit_sand | undefined;
                vary(next?: $giper_baza_vary_type): $giper_baza_vary_type;
        ...
        schema: {
            ...
            readonly Items: typeof $giper_baza_list_link;
            readonly Tasks: {
                new (): {
                    remote_list(next?: readonly $bog_tracker_task[] | undefined): readonly $bog_tracker_task[];
                    remote_add(item: $bog_tracker_task): void;
            ...
            readonly Profile: {
                new (): {
                    Value: () => typeof $bog_tracker_profile;
                    remote(next?: $bog_tracker_profile | null | undefined): $bog_tracker_profile | null;
                    remote_of(peer: $giper_baza_link | null, next?: $bog_tracker_profile | null | undefined): $bog_tracker_profile | null;
                    ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_profile | null;
                    ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_tracker_profile | null;
...
declare namespace $ {
	...
	type $mol_check_icon__hint_bog_tracker_row_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_icon['hint'] >
	>
	type $mol_check_icon__checked_bog_tracker_row_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_row['task_done'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_check_icon__Icon_bog_tracker_row_3 = $mol_type_enforce<
		ReturnType< $bog_tracker_row['Check_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_view__sub_bog_tracker_row_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_row_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_row_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_row_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_row_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_button_minor__click_bog_tracker_row_9 = $mol_type_enforce<
		ReturnType< $bog_tracker_row['task_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_bog_tracker_row_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_view__sub_bog_tracker_row_11 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_tracker_row extends $mol_view {
		task_done( next?: boolean ): boolean
		Check_icon( ): $mol_icon_check
		Check( ): $mol_check_icon
		task_click( next?: any ): any
		Title_row( ): $mol_view
		Subject( ): $mol_view
		Deadline( ): $mol_view
		Assignee( ): $mol_view
		Meta( ): $mol_view
		Main( ): $mol_button_minor
		Priority( ): $mol_view
		task_id( ): string
		task_title( ): string
		task_subject( ): string
		...
		attr( ): ({ 
			'bog_tracker_row_overdue': ReturnType< $bog_tracker_row['task_overdue'] >,
			'bog_tracker_row_priority': ReturnType< $bog_tracker_row['task_priority'] >,
		})  & ReturnType< $mol_view['attr'] >
		sub( ): readonly(any)[]
	}
...
//# sourceMappingURL=row.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_tracker_row extends $.$bog_tracker_row {
    }
}
...
declare namespace $ {
	...
	type $mol_paragraph__title_bog_tracker_list_1 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['empty_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_switch__value_bog_tracker_list_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['filter'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_tracker_list_3 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['filter_options'] >
		,
		ReturnType< $mol_switch['options'] >
	>
	type $mol_button_major__title_bog_tracker_list_4 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['new_task_title'] >
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_tracker_list_5 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['new_task_click'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_view__sub_bog_tracker_list_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_tracker_row__task_id_bog_tracker_list_7 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_id'] >
		,
		ReturnType< $bog_tracker_row['task_id'] >
	>
	type $bog_tracker_row__task_title_bog_tracker_list_8 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_title'] >
		,
		ReturnType< $bog_tracker_row['task_title'] >
	>
	type $bog_tracker_row__task_subject_bog_tracker_list_9 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_subject'] >
		,
		ReturnType< $bog_tracker_row['task_subject'] >
	>
	type $bog_tracker_row__task_deadline_bog_tracker_list_10 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_deadline'] >
		,
		ReturnType< $bog_tracker_row['task_deadline'] >
	>
	type $bog_tracker_row__task_priority_bog_tracker_list_11 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_priority'] >
		,
		ReturnType< $bog_tracker_row['task_priority'] >
	>
	type $bog_tracker_row__task_done_bog_tracker_list_12 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_done'] >
		,
		ReturnType< $bog_tracker_row['task_done'] >
	>
	type $bog_tracker_row__task_overdue_bog_tracker_list_13 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_overdue'] >
		,
		ReturnType< $bog_tracker_row['task_overdue'] >
	>
	type $bog_tracker_row__task_assignee_bog_tracker_list_14 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_assignee'] >
		,
		ReturnType< $bog_tracker_row['task_assignee'] >
	>
	type $bog_tracker_row__task_click_bog_tracker_list_15 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_click'] >
		,
		ReturnType< $bog_tracker_row['task_click'] >
	>
	type $mol_list__rows_bog_tracker_list_16 = $mol_type_enforce<
		ReturnType< $bog_tracker_list['task_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_view__sub_bog_tracker_list_17 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_tracker_list extends $mol_page {
		filter( next?: string ): string
		new_task_click( next?: any ): any
		task_id( id: any): string
		task_title( id: any): string
		task_subject( id: any): string
		task_deadline( id: any): string
		task_priority( id: any): string
		task_done( id: any, next?: boolean ): boolean
		task_overdue( id: any): boolean
		task_assignee( id: any): string
		task_click( id: any, next?: any ): any
		...
		Filter_switch( ): $mol_switch
		New_task( ): $mol_button_major
		Head_bar( ): $mol_view
		Row( id: any): $bog_tracker_row
		Rows_list( ): $mol_list
		Empty( ): $mol_view
		head( ): readonly(any)[]
		body( ): ReturnType< $bog_tracker_list['content'] >
	}
...
//# sourceMappingURL=list.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_tracker_list extends $.$bog_tracker_list {
        filter(next?: any): string;
        registry_ready(): boolean;
        all_tasks(): readonly $bog_tracker_task[];
        filtered_tasks(): readonly $bog_tracker_task[];
        row_ids(): string[];
        task_rows(): $.$bog_tracker_row[];
        task_by_id(id: string): $bog_tracker_task | null;
        task_id(id: string): string;
        task_title(id: string): string;
        task_subject(id: string): string;
        task_deadline(id: string): string;
        task_priority(id: string): any;
        task_done(id: string, next?: boolean): boolean;
        task_overdue(id: string): boolean;
        task_assignee(id: string): string;
        task_click(id: string, next?: any): any;
        new_task_click(next?: any): any;
        content(): $mol_view[];
    }
}
...
declare namespace $ {
	...
	type $mol_button_minor__title_bog_tracker_task_form_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_tracker_task_form_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['back_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_string__hint_bog_tracker_task_form_3 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_bog_tracker_task_form_4 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['draft_subject'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_labeler__title_bog_tracker_task_form_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_task_form_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_textarea__hint_bog_tracker_task_form_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_bog_tracker_task_form_8 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['draft_title'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_labeler__title_bog_tracker_task_form_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_task_form_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_date__value_bog_tracker_task_form_11 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['draft_deadline'] >
		,
		ReturnType< $mol_date['value'] >
	>
	type $mol_labeler__title_bog_tracker_task_form_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_task_form_13 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_switch__value_bog_tracker_task_form_14 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['draft_priority'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_tracker_task_form_15 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['priority_options'] >
		,
		ReturnType< $mol_switch['options'] >
	>
	type $mol_labeler__title_bog_tracker_task_form_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_task_form_17 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_string__hint_bog_tracker_task_form_18 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_bog_tracker_task_form_19 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['draft_assignee'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_labeler__title_bog_tracker_task_form_20 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_tracker_task_form_21 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_button_major__title_bog_tracker_task_form_22 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_tracker_task_form_23 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_form['save_click'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_list__rows_bog_tracker_task_form_24 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	export class $bog_tracker_task_form extends $mol_page {
		back_click( next?: any ): any
		Back( ): $mol_button_minor
		draft_subject( next?: string ): string
		Subject_input( ): $mol_string
		Subject_field( ): $mol_labeler
		draft_title( next?: string ): string
		Title_input( ): $mol_textarea
		Title_field( ): $mol_labeler
		draft_deadline( next?: string ): string
		Deadline_input( ): $mol_date
		Deadline_field( ): $mol_labeler
		draft_priority( next?: string ): string
		Priority_input( ): $mol_switch
		Priority_field( ): $mol_labeler
		draft_assignee( next?: string ): string
		Assignee_input( ): $mol_string
		Assignee_field( ): $mol_labeler
		save_click( next?: any ): any
...
//# sourceMappingURL=form.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_tracker_task_form extends $.$bog_tracker_task_form {
        back_click(next?: any): any;
        save_click(next?: any): any;
    }
}
...
declare namespace $ {
	...
	type $mol_paragraph__title_bog_tracker_task_page_1 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_author_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_body_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_3 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_date_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_4 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['no_task_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_button_minor__title_bog_tracker_task_page_5 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['back_title'] >
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_button_minor__click_bog_tracker_task_page_6 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['back_click'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_check_box__checked_bog_tracker_task_page_7 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['done'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_check_box__title_bog_tracker_task_page_8 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['done_label'] >
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_9 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['subject_label'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_10 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['deadline_label'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_11 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['priority_label'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_12 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['assignee_label'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_13 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['author_label'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_view__sub_bog_tracker_task_page_14 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_task_page_15 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_16 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_list__rows_bog_tracker_task_page_17 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_rows'] >
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_paragraph__title_bog_tracker_task_page_18 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_empty_text'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_textarea__hint_bog_tracker_task_page_19 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_bog_tracker_task_page_20 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_button_major__title_bog_tracker_task_page_21 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_major['title'] >
	>
	type $mol_button_major__click_bog_tracker_task_page_22 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comment_submit'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_view__sub_bog_tracker_task_page_23 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_task_page_24 = $mol_type_enforce<
		ReturnType< $bog_tracker_task_page['comments_block_content'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_task_page_25 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_list__rows_bog_tracker_task_page_26 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	export class $bog_tracker_task_page extends $mol_page {
		back_click( next?: any ): any
		done( next?: boolean ): boolean
		comment_author_text( id: any): string
		Comment_author( id: any): $mol_paragraph
		comment_body_text( id: any): string
		Comment_body( id: any): $mol_paragraph
		comment_date_text( id: any): string
		Comment_date( id: any): $mol_paragraph
		comment_rows( ): readonly(any)[]
		comment_text( next?: string ): string
		comment_submit( next?: any ): any
		comments_block_content( ): readonly(any)[]
		Missing_text( ): $mol_paragraph
		content( ): readonly(any)[]
		title( ): string
		store( ): $bog_tracker_store
		task_id( ): string
		...
		author_label( ): string
		done_label( ): string
		comment_empty_text( ): string
		back_title( ): string
		Back( ): $mol_button_minor
		Done_toggle( ): $mol_check_box
		tools( ): readonly(any)[]
		Subject_row( ): $mol_paragraph
		Deadline_row( ): $mol_paragraph
		Priority_row( ): $mol_paragraph
		Assignee_row( ): $mol_paragraph
		Author_row( ): $mol_paragraph
		Meta_block( ): $mol_view
		Comment_row( id: any): $mol_view
		Comments_title( ): $mol_paragraph
		Comments_list( ): $mol_list
		Comment_empty( ): $mol_paragraph
		Comment_input( ): $mol_textarea
		Comment_submit( ): $mol_button_major
		Comment_form( ): $mol_view
		Comments_block( ): $mol_view
		Missing( ): $mol_view
		Body_content( ): $mol_list
		body( ): ReturnType< $bog_tracker_task_page['content'] >
	}
...
//# sourceMappingURL=page.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_tracker_task_page extends $.$bog_tracker_task_page {
        task_id(): string;
        task(): $bog_tracker_task | null;
        title(): string;
        subject(): string;
        deadline_text(): string;
        priority(): any;
        ...
        assignee_label(): string;
        author_label(): string;
        comments(): readonly $bog_tracker_comment[];
        comment_ids(): string[];
        comment_rows(): $mol_view[];
        comment_by_id(id: string): $bog_tracker_comment | null;
        comment_author_text(id: string): string;
        comment_body_text(id: string): string;
        comment_date_text(id: string): string;
        back_click(next?: any): any;
        comment_submit(next?: any): any;
        content(): $mol_view[];
        comments_block_content(): $.$mol_list[] | $.$mol_paragraph[];
    }
}
...
declare namespace $ {
    const $bog_theme: Record<"image" | "line" | "text" | "current" | "field" | "hover" | "focus" | "background" | "back" | "card" | "special" | "control" | "shade" | "spirit", $mol_style_func<"var", unknown>>;
...
declare namespace $ {
    ...
    class $hyoo_crus_sand extends $hyoo_crus_unit {
        ...
        dump(): {
            ...
            head: string;
            self: string;
            tip: "str" | "bool" | "int" | "real" | "time" | "json" | "ref" | "nil" | "bin" | "ints" | "reals" | "dur" | "range" | "jsan" | "dom" | "tree";
            tag: "keys" | "term" | "solo" | "vals";
            size: number;
            time: string;
        };
...
declare namespace $ {
	...
	type $mol_view__style_bog_tracker_progress_1 = $mol_type_enforce<
		({ 
			'width': ReturnType< $bog_tracker_progress['percent_width'] >,
		}) 
		,
		ReturnType< $mol_view['style'] >
	>
	type $mol_view__sub_bog_tracker_progress_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_tracker_progress_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_tracker_progress extends $mol_view {
		Fill( ): $mol_view
		Track( ): $mol_view
		Label( ): $mol_view
		done_count( ): number
...
declare namespace $.$$ {
    class $bog_tracker_progress extends $.$bog_tracker_progress {
        label(): string;
        percent_width(): string;
    }
}
...
declare namespace $ {
	...
	type $bog_tracker_list__store_bog_tracker_app_1 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['store'] >
		,
		ReturnType< $bog_tracker_list['store'] >
	>
	type $bog_tracker_task_form__store_bog_tracker_app_2 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['store'] >
		,
		ReturnType< $bog_tracker_task_form['store'] >
	>
	type $bog_tracker_task_page__store_bog_tracker_app_3 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['store'] >
		,
		ReturnType< $bog_tracker_task_page['store'] >
	>
	type $bog_tracker_profile_page__store_bog_tracker_app_4 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['store'] >
		,
		ReturnType< $bog_tracker_profile_page['store'] >
	>
	type $mol_link_source__uri_bog_tracker_app_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $bog_theme_toggle__theme_auto_bog_tracker_app_6 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['Theme'] >
		,
		ReturnType< $bog_theme_toggle['theme_auto'] >
	>
	type $bog_theme_auto__theme_light_bog_tracker_app_7 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_light'] >
	>
	type $bog_theme_auto__theme_dark_bog_tracker_app_8 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_theme_auto['theme_dark'] >
	>
	type $bog_theme_auto__themes_bog_tracker_app_9 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_theme_auto['themes'] >
	>
	type $mol_switch__value_bog_tracker_app_10 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['screen'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_tracker_app_11 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['nav_options'] >
		,
		ReturnType< $mol_switch['options'] >
	>
	type $bog_tracker_progress__done_count_bog_tracker_app_12 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['done_count'] >
		,
		ReturnType< $bog_tracker_progress['done_count'] >
	>
	type $bog_tracker_progress__total_count_bog_tracker_app_13 = $mol_type_enforce<
		ReturnType< $bog_tracker_app['total_count'] >
		,
		ReturnType< $bog_tracker_progress['total_count'] >
	>
	export class $bog_tracker_app extends $mol_page {
		Home( ): $bog_tracker_list
		New( ): $bog_tracker_task_form
		Task( ): $bog_tracker_task_page
		Profile( ): $bog_tracker_profile_page
		Lk( ): $bog_lk
		...
		store( ): $bog_tracker_store
		pages( ): ({ 
			'home': ReturnType< $bog_tracker_app['Home'] >,
			'new': ReturnType< $bog_tracker_app['New'] >,
			'task': ReturnType< $bog_tracker_app['Task'] >,
			'profile': ReturnType< $bog_tracker_app['Profile'] >,
			'lk': ReturnType< $bog_tracker_app['Lk'] >,
		}) 
		nav_options( ): ({ 
			'home': string,
			'profile': string,
		...
		Navbar( ): $mol_switch
		Progress( ): $bog_tracker_progress
		tools( ): readonly(any)[]
		head( ): readonly(any)[]
		plugins( ): readonly(any)[]
		body( ): ReturnType< $bog_tracker_app['screen_body'] >
	}
...
declare namespace $.$$ {
    class $bog_tracker_app extends $.$bog_tracker_app {
        screen(next?: string): string;
        screen_body(): any[];
        all_tasks(): readonly $bog_tracker_task[];
        total_count(): number;
